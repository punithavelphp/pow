...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('AL_CustomerAttribute::save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('AL_CustomerAttribute::customer_attributes')
    ...
    protected function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('Customer'), __('Customer'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Customer Attributes'))
            ->setActiveMenu('AL_CustomerAttribute::customer_attributes');
        if (!empty($title)) {
