...
class Banner extends Generic implements TabInterface {
    ...
    Type $typeOptions, Template $template, Enabledisable $statusOptions, Context $context, Registry $registry, FormFactory $formFactory, HelperImage $imageHelper, FieldFactory $fieldFactory, DataObject $objectConverter, WysiwygConfig $wysiwygConfig, array $data = []
    ) {
    ...
    protected function _prepareForm() {
        ...
        if ($banner->getId()) {
            $fieldset->addField(
                    'banner_id', 'hidden', ['name' => 'banner_id']
            );
        }
        ...
        $fieldset->addField('mobile_type', 'select', [
            'name' => 'mobile_type',
            'label' => __('Mobile Link Type'),
            'title' => __('Mobile Link Type'),
            'options' => [
                '1' => __('Category'),
                '0' => __('Product'),
            ],
        ...
        $fieldset->addField('mobile_link_id', 'text', [
            'name' => 'mobile_link_id',
            'label' => __('Mobile Link ID'),
            'title' => __('Mobile Link ID'),
            'note' => __('Id of the Category or Product.')
        ]);
