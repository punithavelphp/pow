<?php
namespace MageArray\Testimonials\Helper;
...
{
    const XML_PATH_ITEMS_PER_PAGE = 'magearray/general/postonlist';
    const XML_PATH_POST_SORT_ORDER = 'magearray/general/post_sorting';
    const XML_PATH_LIST_PAGE_LAYOUT = 'magearray/general/post_list_layout';
    const XML_PATH_COMMENTS_PER_PAGE = 'magearray/comments/commentcount';

    const MEDIA_PATH = 'magearray/blog/image/';
    ...
    {
        return abs((int)$this->_scopeConfig->getValue(
    ...
    public function resize(\MageArray\Blog\Model\Blogpost $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    public function resizeThumb(\MageArray\Blog\Model\Blogpost $item, $width, $height = null)
    {
