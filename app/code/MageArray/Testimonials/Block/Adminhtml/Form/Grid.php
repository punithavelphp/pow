<?php
namespace MageArray\Testimonials\Block\Adminhtml\Form;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \MageArray\Testimonials\Model\TestimonialsFactory
     */
     ...
     * @param \MageArray\Testimonials\Model\TestimonialsFactory $testimonialsFactory
     * @param \MageArray\Testimonials\Model\Status $status
    ...
    public function __construct(
        ...
        \MageArray\Testimonials\Model\TestimonialsFactory $testimonialsFactory,
        \MageArray\Testimonials\Model\Status $status,
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('magearray_testimonial');
