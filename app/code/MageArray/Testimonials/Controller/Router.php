...
namespace MageArray\Testimonials\Controller;
...
use MageArray\Testimonials\Model\TestimonialsFactory;
...
class Router implements RouterInterface
{
    ...
    public function __construct(
        ...
        \MageArray\Testimonials\Helper\Data $dataHelper
    ) {
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        if (!$this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'magearray_testimonials_controller_router_match_before',
            ...
            if (($identifier != null) && ($this->getPageUrl() != null) && ($identifier == $this->getPageUrl())) {
