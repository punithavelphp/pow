 ...
 */
namespace MageArray\Testimonials\Controller\Index;

use MageArray\Testimonials\Model\Image as ImageModel;
use MageArray\Testimonials\Model\Upload;
...
class Post extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($post) {
                $currenttime = time();
                $model = $this->_objectManager->create(\MageArray\Testimonials\Model\Testimonials::Class);

                $model->setData($post);
                $avatarPath = $this->uploadModel->uploadFileAndGetName(
                    'avatar_path',
                ...
                $storeConfig = $this->_objectManager->create(\Magento\Store\Model\StoreManagerInterface::Class);
