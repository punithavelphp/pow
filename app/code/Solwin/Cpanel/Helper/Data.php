...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getConfigShopHours($key) {
        return $this->scopeConfig->getValue('hours/opening_hours/'.$key,\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
	
	public function getConfigDeliveryHours($key) {
        return $this->scopeConfig->getValue('hours/delivery_hours/'.$key,\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
