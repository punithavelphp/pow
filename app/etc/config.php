...
return [
    'modules' => [
        ...
        'AL_CustomerAttribute' => 1,
        'Bajaj_StorePickup' => 1,
        'Ecomteck_DeliveryDate' => 1,
        'Lof_All' => 1,
        'Lof_CustomerAvatar' => 1,
        'MMA_CustomApi' => 1,
        'MageArray_Testimonials' => 1,
        'Magefan_Community' => 1,
        'Magefan_Cli' => 1,
        'Magefan_Blog' => 1,
        ...
        'Magepow_Ajaxcart' => 1,
        'Magetop_AjaxCartPro' => 1,
        'Mstore_Catalog' => 1,
        'Mstore_CategoriesList' => 1,
        'Mstore_Checkout' => 1,
        'Mstore_ContactUs' => 1,
        'Mstore_Customer' => 1,
        'Mstore_OrdersList' => 1,
        'Mstore_ProductsList' => 1,
        'Mstore_Sales' => 1,
        'Mstore_SocialLogin' => 1,
        'Mstore_Store' => 1,
        'Mstore_Wishlist' => 1,
        'Mtwo_Configurations' => 1,
        'Mtwo_Mobile' => 1,
        'Mtwo_Pickup' => 1,
        'Mtwo_ProductAttributes' => 1,
        'Plumrocket_Base' => 1,
